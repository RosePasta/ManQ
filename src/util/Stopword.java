...
//    	return false;
	...
	static {
		...
		String javaKeywords[] = { "abstract", "continue", "for", "new", "switch", "assert", "default", "goto",
		...
		String projectKeywords[] = { "args", "method", "main", "param", "aspectj", "swt", "eclipse", "zxing", 
				"java", "org", "javadoc", "annotation", "patch", "attachment",
				"bug","jdt","tomcat","ecf","pde", "jre", "apache"}; // Rose
		...
		String EngStopWord[] = { "a", "a's", "able", "about", "above", "according", "accordingly", "across", "actually",
				...
				"won't", "wonder", "would", "would", "wouldn't", "x", "y", "yes", "yet", "you", "you'd", "you'll","'ve","n't",
				"you're", "you've", "your", "yours", "yourself", "yourselves", "z", "zero", "don","isn", "doesn", "nice","very"}; // Rose
		...
		for (int i = 0; i < EngStopWord.length; i++) {
			...
			if(word.contains("\'")){
				ENG_STOP_WORDS_SET.add(word.replace("\'", ""));
			}
		}
	}
}